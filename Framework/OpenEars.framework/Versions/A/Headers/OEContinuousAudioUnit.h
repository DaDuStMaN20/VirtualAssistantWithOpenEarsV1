...
- (void) testFileChange;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSError *startAudioUnit;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSError *stopAudioUnit;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSError *setupAudioSession;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSError *setupAudioUnit;
@property (NS_NONATOMIC_IOSONLY, getter=getCurrentRoute, readonly, copy) NSString *currentRoute;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSError *teardownAudioSession;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSError *teardownAudioUnit;
